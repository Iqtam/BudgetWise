						...
						{#if budgetInsights.alert.type === 'overspending_forecast'}
							<div class="rounded-lg border border-red-500/20 bg-red-500/10 p-4">
								...
								<p class="mt-1 text-sm text-gray-300">
									...
									period. You're spending ${budgetInsights.alert.forecast?.dailySpendRate.toFixed(
										2
									)}
						...
						{:else if budgetInsights.alert.type === 'over_budget'}
							<div class="rounded-lg border border-red-500/20 bg-red-500/10 p-4">
								...
								<p class="mt-1 text-sm text-gray-300">
									...
									by ${budgetInsights.alert.overAmount?.toFixed(2)}. Consider adjusting your
									spending or increasing the budget limit.
								</p>
							</div>
